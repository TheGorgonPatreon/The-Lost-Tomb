(() => {
  const adventureName = 'The Lost Tomb';
  const moduleName = 'the-lost-tomb';
   ...
   */
  const welcomeJournal = 'Welcome to The Lost Tomb!';
  /**
   ...
   */
  const additionalModulePacks = ["the-lost-tomb","dnd5e"];
